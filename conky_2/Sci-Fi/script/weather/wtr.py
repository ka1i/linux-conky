...
wcr = pywapi.get_weather_from_weather_com('CHXX0016')
curcond_file = os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/current_condition'
forecast_file = os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/forecast'
icons_path = os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/weather_icons/'
_icons_path = os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/weather_icons/'
...
for elements in forcast:
    ...
    cond.append(os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/weather_icons/day/' + elements['day']['text'].lower().replace(' ', '') + '.png')
    cond[0] = os.environ['HOME'] + '/.conky/Sci-Fi/script/weather/weather_icons/day/' + wtr['TXT'] + '.png'
...
def main():
    ...
    print('${voffset -5}' + '${goto 10}' + fontIt('DIN', '60', wtr['TMP']), imageIt(wtr['ICO'], 90, 30, 60, 60), \
            imageIt(_icons_path + 'temperature.png', 10, 105, 20, 20), \
            imageIt(_icons_path + 'humidity.png', 10, 140, 20, 20), \
            imageIt(_icons_path + 'barometer.png', 10, 175, 20, 20), \
            imageIt(_icons_path + 'dewpoint.png', 10, 210, 20, 20), \
            imageIt(_icons_path + 'chance_precip.png', 10, 245, 20, 20), \
            imageIt(_icons_path + 'wind_direction.png', 10, 280, 20, 20), \
            imageIt(_icons_path + 'sunrise.png', 10, 315, 20, 20), \
            imageIt(_icons_path + 'sunset.png', 10, 350, 20, 20))
